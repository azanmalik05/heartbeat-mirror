...
def show_guess_light(guess_bpm):

    brightness = (guess_bpm - 40) / (180 - 40)
    ...
    red_value = int(255 * brightness)

    pixels.fill((red_value, 0, 0))
...
while True:
    ...
    show_guess_light(guess_bpm)

    #print("RAW:", slider.value, "| Guess BPM:", guess_bpm)
